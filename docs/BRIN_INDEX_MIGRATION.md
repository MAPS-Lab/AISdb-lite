...
- **Server**: bigdata6 (production-like workload)
...
Three benchmark scripts are available for comprehensive validation:
...
*Scripts located in `/codes` directory (external to repository).*
